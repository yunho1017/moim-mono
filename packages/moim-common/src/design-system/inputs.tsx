...
import colorSetReconciler from "../helpers/colorSetReconciler";
...
export const Radio = styled.input.attrs({ type: "radio" })`
  ...
  &::before {
    ...
    border: ${px2rem(2)} solid
      ${(props) => props.theme.colorV2.colorSet.grey300};
  }
  &::after {
    width: 100%;
    height: 100%;
...
export const Checkbox: React.FC<React.ComponentProps<typeof CheckboxBase>> = ({
  ...
  return (
    <CheckboxWrapper onClick={handleClick} disabled={disabled}>
      ...
      />
      {/* TODO: (mono) fix this */}
      <CheckMarkIconWrapper>{/* <CheckMarkIcon /> */}</CheckMarkIconWrapper>
    </CheckboxWrapper>
  );
};
...
export const TextInput = styled.input.attrs({ type: "text" })`
  ...
  caret-color: ${(props) => props.theme.colorV2.accent};
  flex: 1;
  &::placeholder {
