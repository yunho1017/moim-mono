declare namespace Moim {
  namespace Theme {
    ...
    type ReactionButtonElementThemePaletteKey = keyof Group.IReactionButtonElementTheme;
    ...
    type CommonElementThemePaletteProps =
      ...
      | {
          ...
          key: ReactionButtonElementThemePaletteKey;
        };
    ...
    interface IElementThemePalette {
      ...
      reactionButtons: IReactionButtonElementThemePalette;
    }
    ...
    interface IReactionButtonElementThemePalette {
      like: Group.IColorSetWithColor;
      dislike: Group.IColorSetWithColor;
    }
  }
}
