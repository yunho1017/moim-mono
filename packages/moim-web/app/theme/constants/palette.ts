...
export const generateDefaultElementTheme = (): Moim.Group.IElementTheme => ({
  ...
  reactionButtons: {
    like: {
      color: ElementThemeColorValueTypes.SECONDARY_MAIN,
      scale: ThemeColorScaleTypes.BLACK,
    },
    dislike: {
      color: ElementThemeColorValueTypes.SECONDARY_MAIN,
...
export const generateDefaultElementThemeColorSet = (): Moim.Theme.IElementThemePalette => {
  ...
  return {
    ...
    reactionButtons: {
      like: elementTheme2ColorSet(
        defaultPalette,
        defaultElementTheme.reactionButtons.like,
      ),
      dislike: elementTheme2ColorSet(
        defaultPalette,
        defaultElementTheme.reactionButtons.dislike,
      ),
    },
  };
};
