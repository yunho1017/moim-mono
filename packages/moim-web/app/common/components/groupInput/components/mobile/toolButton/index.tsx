...
// icons
import BoldIconBase from "@icon/24-bold-g.svg";
import ItalicIconBase from "@icon/24-italic-g.svg";
import LinkIconBase from "@icon/24-link-g.svg";

import MentionIconBase from "@icon/24-mention-g.svg";
import FileIconBase from "@icon/24-file-g.svg";
import ImageIconBase from "@icon/24-image-g.svg";
import EmojiIconBase from "@icon/24-emoji-g.svg";
import SendIconBase from "@icon/24-send-g.svg";
import TextStyleIconBase from "@icon/18-textstyle-g.svg";
import MeetingIconBase from "@icon/24-video-chat.svg";
