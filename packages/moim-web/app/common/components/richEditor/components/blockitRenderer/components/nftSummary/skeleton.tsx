...
import { Inner, Left, NftSummaryWrapper, Right, Wrapper } from "./styled";
      ...
      <Wrapper>
        <Inner>
          <NftSummaryWrapper>
            ...
            <SkeletonBox
              height={px2rem(19)}
              overrideStyle={titleSkeletonStyle}
            />
            <Spacer value={6} />
            <SkeletonBox
              height={px2rem(16)}
              overrideStyle={nameSkeletonStyle}
            />
            <Spacer value={12} />
            <GridMobileWrapper>
              <SkeletonBox
      ...
      <Inner>
        <NftSummaryWrapper>
          <Left>
            ...
            <SkeletonBox
              height={px2rem(16)}
              overrideStyle={descSkeletonStyle}
            />
          </Left>
          <Right>
            <SkeletonBox
