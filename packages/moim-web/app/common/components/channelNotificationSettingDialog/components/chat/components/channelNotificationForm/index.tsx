  ...
  return (
    <Wrapper>
      <SettingInput
        ...
        title={
          <Title>
            <FormattedMessage id="channel_notification_settings/channel_notification_title" />
          </Title>
        }
        description={
          <FormattedMessage id="channel_notification_settings/channel_notification_guide" />
        }
      />
    </Wrapper>
  );
