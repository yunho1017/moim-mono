...
import { getAccessToken, IOptions } from "../cryptobadge/helpers";
import { CRYPTOBADGE_TOKEN_ENDPOINT_URL } from "common/constants/authentication";
...
describe("cryptobadge authentication", () => {
  ...
  describe("getAccessToken()", () => {
    ...
    describe("When success get authentication", () => {
      it("should get access_token object", async () => {
        const url = new URL(CRYPTOBADGE_TOKEN_ENDPOINT_URL);
